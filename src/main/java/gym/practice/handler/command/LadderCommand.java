...
import gym.practice.utils.BukkitSerialization;
...
public class LadderCommand implements CommandExecutor {
	...
	public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
		...
		if (!sender.hasPermission(this.main.getMessageLoader().getLadderPermissions())) {
		...
		if (args[0].equalsIgnoreCase("create")) {
			...
			final Ladder ladder = new Ladder(args[1], player.getItemInHand(), player.getInventory().getContents(), player.getInventory().getArmorContents(), "&a" + args[1], LadderType.valueOf(args[2]), slots, "true", "true", "true", "default");
